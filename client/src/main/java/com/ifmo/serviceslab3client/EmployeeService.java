 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://serviceslab3maven.ifmo.com/", wsdlLocation = "http://0.0.0.0:8080/EmployeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://serviceslab3maven.ifmo.com/", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://0.0.0.0:8080/EmployeeService?wsdl");
    ...
    public EmployeeWebService getEmployeeWebServicePort() {
        return super.getPort(new QName("http://serviceslab3maven.ifmo.com/", "EmployeeWebServicePort"), EmployeeWebService.class);
    }
    ...
    public EmployeeWebService getEmployeeWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceslab3maven.ifmo.com/", "EmployeeWebServicePort"), EmployeeWebService.class, features);
    }
